...
export class ConsulService
  implements OnModuleInit, OnModuleDestroy, IConsulService {
  private store: Store;
  ...
  constructor(
    ...
    this.deregisterCriticalServiceAfter = get(
      options,
      'healthCheck.deregisterCriticalServiceAfter',
    );
  ...
  private generateService() {
    ...
    if (this.tcp) {
      ...
      check.http = `${this.protocol}://${this.discoveryHost}:${
        this.servicePort
      }${this.route}`;
    }
