...
export class Store {
    ...
    private services: { [service: string]: IServiceNode[] } = {};
    ...
    public setNodes(service: string, nodes: IServiceNode[]) {
    ...
    private createServiceNodesWatcher(service: string) {
        ...
        const watcher = this.watchers[service] = new Watcher(this.consul, {
            ...
            params: { service: service, wait: '5m', timeout: this.WATCH_TIMEOUT }
        });
