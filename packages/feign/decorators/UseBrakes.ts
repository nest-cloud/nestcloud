import { BrakesConfig } from "../options/BrakeOptions";
...
export const Brakes = (config?: BrakesConfig | boolean) => (target, key?, descriptor?) => {
        ...
        brakes.fallback(() => {
            ...
            if (Fallback) {
                ...
                if (module) {
                    ...
                    if (instance) {
                        return execute(instance.fallback());
                    }
                }
            }
